...
//
// The claim/proof-of-possession parameters of requirements.md sec 4.3. The client leans on several of these too: the
...
// Below this size a known blob is re-uploaded instead of challenged -- round trips cost more than the bytes (sec 4.3).
...
// over a multi-gigabyte blob down to kilobytes of reads (sec 4.3).
