...
export default [
    ...
    ...tseslint.configs.stylistic,
    {
        rules: {
            ...
            // ignoredNodes keeps key-spacing out of type-annotation positions, which type-annotation-spacing owns
            // (they fight otherwise -- https://github.com/eslint-stylistic/eslint-stylistic/issues/476). ClassBody
            // covers annotated class fields (`label : string = 'x'`), which hit the same conflict.
